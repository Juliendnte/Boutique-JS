...
-- 2    
    ("A. Lange & Sohne", "Tourbillon Pour Le Merite Limited Edition", "701.001", 242850, "Allemagne", "38mm", "Or jaune","Argent", "30m", "Montre à remontage manuel", "Heures et minutes , Indicateur de réserve de marche , Secondes , Tourbillon", "Alligator", "Marron",DEFAULT,NULL, 2,
...
-- 3   
    ("A. Lange & Sohne", "1815 Rattrapante Calendrier Perpétuel", "421.032FE", 129000, "Allemagne", "41mm", "Or rose","Argent", "30m", "Montre à remontage manuel", "Calendrier , Chronographe , Date , Jour , Heures et minutes , Phase de lune , Indicateur de réserve de marche , Secondes", "Alligator", "Marron",DEFAULT,NULL, 2,
...
-- 4
    ("A. Lange & Sohne", "Lange 1", "101.027", 56500, "Allemagne", "38mm", "Or blanc","Bleu", "50m", "Montre à remontage manuel", "Date , Heures et minutes , Indicateur de réserve de marche , Secondes", "Alligator", "Marron",DEFAULT,NULL, 1,
...
-- 5
    ("A. Lange & Sohne", "Lange 1", "101.022", 26550, "Allemagne", "38mm", "Or jaune","Argent", "30m", "Montre à remontage manuel", "Date , Heures et minutes , Indicateur de réserve de marche , Secondes", "Alligator", "Noir",DEFAULT,NULL, 2,
...
-- 6  
    ("A. Lange & Sohne", "Grand Lange 1 Moonphase Lumen", "139.035F", 121400, "Allemagne", "41mm", "Platine","Noir", "30m", "Montre à remontage manuel", "Date , Heures et minutes , Phase de lune , Indicateur de réserve de marche , Secondes", "Alligator", "Noir",DEFAULT,NULL, 2,
...
-- 7
    ("A. Lange & Sohne", "Langematik", "308.021", 17450, "Allemagne", "37mm", "Or jaune","Argent", "50m", "Automatique", "Date , Heures et minutes , Secondes", "Alligator", "Noir",DEFAULT,NULL, 3,
...
-- 8
    ("A. Lange & Sohne", "Grosse Langematick Gangreserve Limited for Wempe", "304.047", 32600, "Allemagne", "40mm", "Or rose","Argent", "30m", "Automatique", "Date , Heures et minutes , Secondes", "Alligator", "Marron",DEFAULT,NULL, 4,
...
-- 9
    ("A. Lange & Sohne", "Langematik Perpetual Calendar", "310.025E", 58650, "Allemagne", "38mm", "Platine","Gris", "30m", "Automatique", "Date , Jour , Gmt/Heure mondiale , Heures et minutes , Phase de lune , Calendrier perpétuel , Secondes", "Alligator", "Noir",DEFAULT,NULL, 5,
    "Montre automatique à remontage automatique A. Lange & Sohne Grosse Langematick Gangreserve Limited pour Wempe (304047) d'occasion, dotée d'un boîtier en or rose 18 carats de 40,5 mm entourant un cadran argenté sur un tout nouveau bracelet en alligator marron avec une boucle ardillon en or rose 18 carats. Les fonctions comprennent les heures, les minutes, la petite seconde et l'indicateur de réserve de marche. Cette montre est soigneusement sélectionnée et méticuleusement expertisée par nos maîtres horlogers Horo Haven, garantissant ainsi son authenticité et sa qualité irréprochable. Livrée avec ses papiers d'origine, chaque pièce incarne l'exclusivité et l'élégance intemporelle que seul Horo Haven peut vous offrir." ),
-- 10
    ("A. Lange & Sohne", "Richard Lange Tourbillon ""Pour le Merite"" ", "760.026F", 130550, "Allemagne", "41mm", "Or blanc","Argent", "30m", "Montre à remontage manuel", "Heures et minutes , Secondes , Tourbillon", "Alligator", "Marron",DEFAULT,NULL, 5,
...
-- 11
    ("A. Lange & Sohne", "Richard Lange Tourbillon ""Pour le Merite"" ", "760.032", 125300, "Allemagne", "41mm", "Or rose","Argent", "30m", "Montre à remontage manuel", "Heures et minutes , Secondes , Tourbillon", "Alligator", "Marron",DEFAULT,NULL, 2,
...
-- 12
    ("A. Lange & Sohne", "Richard Lange Tourbillon ""Pour le Merite"" ", "760.025", 130750, "Allemagne", "41mm", "Platine","Argent", "50m", "Montre à remontage manuel", "Heures et minutes , Secondes , Tourbillon", "Alligator", "Noir",DEFAULT,NULL, 3,
...
-- 13
    ("A. Lange & Sohne", "Saxonia", "760.025", 130750, "Allemagne", "41mm", "Or blanc","Bleu", "30m", "Automatique", "Heures et minutes , Secondes", "Alligator", "Bleu",DEFAULT,NULL, 3,
...
-- 14
    ("A. Lange & Sohne", "Saxonia", "309.021", 20600, "Allemagne", "40mm", "Or jaune","Champagne", "30m", "Automatique", "Date , Heures et minutes , Secondes", "Alligator", "Marron",DEFAULT,NULL, 2,
...
-- 15
    ("A. Lange & Sohne", "Saxonia", "403.031", 102050, "Allemagne", "39mm", "Or rose","Noir", "50m", "Montre à remontage manuel", "Chronographe , Date , Heures et Minutes , Secondes , Tachymètre", "Alligator", "Bordeaux",DEFAULT,NULL, 1,
...
-- 16
    ("A. Lange & Sohne", "Zeitwerk Date", "148.038", 101200, "Allemagne", "44mm", "Or blanc","Gris", "30m", "Montre à remontage manuel", "Date , Heures et minutes , Indicateur de réserve de marche , Secondes", "Alligator", "Noir",DEFAULT,NULL, 5,
...
-- 17
    ("A. Lange & Sohne", "Zeitwerk Minute Repeater", "147.025", 260650, "Allemagne", "44mm", "Platine","Argent", "30m", "Montre à remontage manuel", "Date , Heures et minutes , Indicateur de réserve de marche , Secondes", "Alligator", "Noir",DEFAULT,NULL, 5,
...
-- 18
    ("Audemars Piguet", "Code 11.59", "15210QT.OO.A064KB.01", 29900, "Suisse", "41mm", "Acier inoxydable","Noir, Gris", "30m", "Automatique", "Date , Heures et minutes ,  Secondes", "Caoutchouc", "Marron",DEFAULT,NULL, 1,
...
-- 19
    ("Audemars Piguet", "Code 11.59 Perpetual Calendar", "26394BC.OO.D027KB.01", 74450, "Suisse", "41mm", "Or blanc","Bleu", "20m", "Automatique", "Date , Jour , Heures et minutes , Mois , Phase de lune , Calendrier perpétuel , Secondes", "Cuir", "Gris",DEFAULT,NULL, 2,
...
-- 20
    ("Audemars Piguet", "Code 11.59", "15210OR.OO.A028CR.01", 28050, "Suisse", "41mm", "Or rose","Bleu", "30m", "Automatique", "Heures et minutes , Secondes", "Alligator", "Bleu",DEFAULT,NULL, 2,
...
-- 21
    ("Audemars Piguet", "Jules Audemars Grande Sonnerie Minute Repeater", "25750BA.OO.A002XX.01", 84050, "Suisse", "39mm", "Or jaune","Blanc", "Non précisé", "Montre à remontage manuel", "Heures et Minutes , Secondes", "Alligator", "Noir",DEFAULT,NULL, 3,
...
-- 22
    ("Audemars Piguet", "Jules Audemars Chronometer", "26153OR.OO.D088CR.01", 68200, "Suisse", "46mm", "Or rose","Noir", "20m", "Montre à remontage manuel", "Heures et Minutes , Secondes", "Alligator", "Marron",DEFAULT,NULL, 1,
...
-- 23
    ("Audemars Piguet", "Jules Audemars Double X 6th Day Arnold Schwazeneggar", "25949IP/O/0001KE/01", 28000, "Suisse", "48mm", "Titane","Blanc", "50m", "Automatique", "Chronographe , Heures et Minutes , Secondes", "Tissé", "Noir",DEFAULT,NULL, 2,
...
-- 24
    ("Audemars Piguet", "Royal Oak", "15500ST.OO.1220ST.01", 43000, "Suisse", "41mm", "Acier inoxydable","Bleu", "50m", "Automatique", "Date , Heures et minutes , Secondes", "Acier inoxydable", "Argent",DEFAULT,NULL, 10,
...
-- 25
    ("Audemars Piguet", "Royal Oak Extra-Thin", "15202BC.ZZ.1241BC.02", 290000, "Suisse", "39mm", "Or blanc","Bleu", "50m", "Automatique", "Heures et Minutes , Secondes , Date", "Or blanc", "Argent",DEFAULT,NULL, 1,
...
-- 26
    ("Audemars Piguet", "Royal Oak", "15413OR.YY.1220OR.01", 266450, "Suisse", "41mm", "Or rose","Diamant", "30m", "Automatique", "Heures et Minutes , Secondes , Date", "Or rose", "Or rose",DEFAULT,NULL, 2,
...
-- 27
    ("Audemars Piguet", "Royal Oak Offshore Chronograph", "26238ST.OO.2000ST.01", 44200, "Suisse", "42mm", "Acier inoxydable","Bleu", "100m", "Automatique", "Chronographe , Date , Heures et minutes , Secondes , Tachymètre", "Acier inoxydable", "Argent",DEFAULT,NULL, 3,
...
-- 28
    ("Audemars Piguet", "Royal Oak Offshore Diver Limited Edition", "15720CN.OO.A002CA.01", 41400, "Suisse", "42mm", "Or blanc","Noir", "300m", "Automatique", "Date , Valve de libération d'hélium , Heures et minutes , Secondes", "Caoutchouc", "Noir",DEFAULT,NULL, 1,
...
-- 29
    ("Audemars Piguet", "Royal Oak Offshore Chronograph", "26238OR.OO.2000OR.01", 96000, "Suisse", "42mm", "Or rose","Bleu", "100m", "Automatique", "Chronographe , Date , Heures et minutes , Secondes , Tachymètre", "Or rose", "Or rose",DEFAULT,NULL, 2,
...
-- 30
    ("Breitling", "Bentley", "A2536513/B954", 5050, "Suisse", "48mm", "Acier inoxydable","Noir", "100m", "Automatique", "Chronographe , Date , Heures et Minutes , Secondes", "Alligator", "Noir",DEFAULT,NULL, 5,
...
-- 31
    ("Breitling", "Bentley GT", "K1336212/A576", 14900, "Suisse", "46mm", "Or jaune","Blanc", "100m", "Automatique", "Chronographe , Date , Heures et minutes , Secondes , Règle à calcul", "Cuir", "Marron",DEFAULT,NULL, 2,
...
-- 32
    ("Breitling", "Super Chronomat B01", "UB0136251B1U1", 10100, "Suisse", "44mm", "Acier inoxydable","Noir", "200m", "Automatique", "Chronographe , Date , Heures et minutes , Secondes , Tachymètre", "Deux tons: Or rose/ Acier inoxydable", "Deux tons: Rose/argent",DEFAULT,NULL, 2,
...
-- 33
    ("Breitling", "Chronomat B01", "RB0134101B1S1", 16350, "Suisse", "42mm", "Or rose","Gris", "200m", "Automatique", "Chronographe, Date, Heures et Minutes, Secondes", "Caoutchouc", "Noir",DEFAULT,NULL, 1,
...
-- 34
    ("Breitling", "Chrono-Matic 24 Limited Edition", "A2236013/B817", 3750, "Suisse", "44mm", "Automatique","Acier inoxydable","Noir", "30m", "Heures et Minutes , Secondes , Chronographe , Date , Tachymètre", "Acier inoxydable", "Argent",DEFAULT,NULL, 5,
...
-- 35
    ("Breitling", "Chronomatic", "H2236012/B818", 10250, "Suisse", "44mm", "Or rose","Noir", "30m","Automatique", "Chronographe , Date , Gmt/Heure mondiale , Heures et minutes , Secondes", "Alligator", "Marron",DEFAULT,NULL, 1,
...
-- 36
    ("Breitling", "Navitimer B01 Chronograph", "AB0138211B1A1", 6450, "Suisse", "43mm", "Acier inoxydable","Noir", "30m","Automatique", "Chronographe , Date , Heures et minutes , Secondes , Règle à calcul", "Acier inoxydable", "Argent",DEFAULT,NULL, 2,
...
-- 37
    ("Breitling", "Vintage Navitimer Chronograph", "K1332212", 12100, "Suisse", "41mm", "Or jaune", "Noir", "30m", "Automatique", "Chronographe, Date, Heures et minutes, Secondes, Règle à calcul", "Alligator", "Marron", DEFAULT, NULL, 4, 
...
-- 38
    ("Breitling", "Navitimer B01 Chronograph", "RB0127121G1P2", 16550, "Switzerland", "46mm", "Or rose", "Gris, Argent", "30m", "Automatique", "Heures et Minutes, Secondes, Chronographe, Date, Règle à calcul", "Alligator", "Marron", DEFAULT, NULL, 5, 
...
-- 39
    ("Breitling", "Premier Day & Date", "A45340211G1P2", 3400, "Suisse", "40mm", "Acier inoxydable", "Argent", "100m", "Automatique", "Date, Jour, Heures et Minutes, Secondes", "Alligator", "Marron", DEFAULT, NULL, 3, 
...
-- 40
    ("Breitling", "Premier Automatic", "R37340351G1P1", 9250, "Suisse", "40mm", "Or rose", "Argent", "100m", "Automatique", "Heures et Minutes, Secondes", "Alligator", "Marron", DEFAULT, NULL, 6, 
...
-- 41
    ("Breitling", "Transocean Chronograph", "AB015253/G724", 8150, "Suisse", "43mm", "Acier inoxydable", "Argent", "100m", "Automatique", "Heures, Minutes, Secondes, Date, Chronographe", "Cuir", "Noir", DEFAULT, NULL, 7, 
...
-- 42
    ("Breitling", "Transocean Chronograph", "RB0510U4/BB63", 11550, "Suisse", "46mm", "Or jaune", "Noir", "100m", "Automatique", "Chronographe, Date, Gmt/Heure mondiale, Heures et Minutes, Secondes", "Alligator", "Noir", DEFAULT, NULL, 5, 
...
-- 43
    ("F.P. Journe", "Chronometre Optimum Boutique", "CO BE G 40 A BK", 251850, "Suisse", "40mm", "Or rose", "Noir", "30m", "Montre à remontage manuel", "Heures et minutes, Indicateur de réserve de marche, Secondes", "Alligator", "Noir", DEFAULT, NULL, 3, 
...
-- 44
    ("F.P. Journe", "Chronometre a Resonance", "BL RND PT 40 A BK", 220000, "Suisse", "40mm", "Platine", "Noir", "30m", "Montre à remontage manuel", "Gmt/Heure mondiale, Heures et minutes, Indicateur de réserve de marche, Secondes", "Alligator", "Gris", DEFAULT, NULL, 4, 
...
-- 45
    ("F.P. Journe", "Quantieme Perpetual", "QP G 42 WHG", 102950, "Suisse", "42mm", "Or rose", "Blanc", "30m", "Automatique", "Date, Jour, Heures et Minutes, Mois, Indicateur de réserve de marche, Secondes", "Cuir", "Marron", DEFAULT, NULL, 6, 
...
-- 46
    ("F.P. Journe", "Octa Quantieme Perpetuel", "QP PT 42 A BLG", 130450, "Suisse", "42mm", "Platine", "Bleu", "30m", "Automatique", "Date, Jour, Heures et Minutes, Mois, Calendrier perpétuel, Indicateur de réserve de marche, Secondes", "Alligator", "Bleu", DEFAULT, NULL, 7, 
...
-- 47
    ("F.P. Journe", "Chronometre Bleu", "CSBLEU TA 39 A BL", 79050, "Suisse", "39mm", "Tantale", "Bleu", "30m", "Montre à remontage manuel", "Heures et minutes, Secondes", "Alligator", "Tan", DEFAULT, NULL, 4, 
...
-- 48
    ("F.P. Journe", "Linesport Centigraphe Sport", "L-CTS AL 42 D GR", 121450, "Suisse", "42mm", "Aluminium", "Gris", "30m", "Montre à remontage manuel", "Chronographe, Heures et Minutes, Secondes", "Caoutchouc", "Noir", DEFAULT, NULL, 5, 
...
-- 49
    ("F.P. Journe", "Sport Chronograph", "CR G 44 B GR", 121450, "Suisse", "44mm", "Or rose", "Gris", "30m", "Montre à remontage manuel", "Chronographe, Heures et Minutes, Secondes", "Or rose", "Or rose", DEFAULT, NULL, 6, 
...
-- 50
    ("F.P. Journe", "Chronographe Monopoussoir Rattrapante", "CRT TI 44 B GR", 88100, "Suisse", "44mm", "Titane", "Gris", "30m", "Montre à remontage manuel", "Chronographe, Date, Heures et minutes, Secondes", "Titane", "Gris", DEFAULT, NULL, 3, 
...
-- 51
    ("F.P. Journe", "Octa Sport", "L-OSA AL 42 D GR", 55600, "Suisse", "42mm", "Aluminium", "Gris", "30m", "Automatique", "Date, Indicateur jour/nuit, Heures et minutes, Indicateur de réserve de marche, Secondes", "Caoutchouc", "Noir", DEFAULT, NULL, 5, 
...
-- 52
    ("F.P. Journe", "Octa Calendrier", "O-OCA G 38 A SI", 249200, "Suisse", "38mm", "Or rose", "Gris, Argent", "30m", "Automatique", "Date, Jour, Heures et minutes, Secondes", "Alligator", "Bleu", DEFAULT, NULL, 2, 
...
-- 53
    ("F.P. Journe", "Octa Calendrier", "O-OCA PT 38 A SI", 139150, "Suisse", "38mm", "Platine", "Gris, Argent", "30m", "Automatique", "Date, Jour, Heures et minutes, Mois, Secondes", "Alligator", "Noir", DEFAULT, NULL, 4, 
...
-- 54
    ("F.P. Journe", "Chronometre A Resonance", "S-RN G 40 A RG", 222950, "Suisse", "40mm", "Or rose", "Rose, Argent", "30m", "Montre à remontage manuel", "Gmt/Heure mondiale, Heures et minutes, Indicateur de réserve de marche, Secondes", "Alligator", "Marron", 1, 
...
-- 55
    ("F.P. Journe", "Tourbillon Souverain", "S-TN PT 40 B SI", 325600, "Suisse", "40mm", "Platine", "Gris", "30m", "Montre à remontage manuel", "Heures et minutes, Secondes, Tourbillon", "Platine", "Platine", DEFAULT, NULL,5, 
...
-- 56
    ("H. Moser & Cie.", "Endeavour Perpetual Calendar", "1341-0200", 23150, "Suisse", "40mm", "Or blanc", "Argent", "30m", "Montre à remontage manuel", "Date, Heures et minutes, Mois, Calendrier perpétuel, Indicateur de réserve de marche, Secondes", "Alligator", "Noir", DEFAULT, NULL, 2, 
...
-- 57
    ("H. Moser & Cie.", "Endeavour Perpetual Calendar", "341.501.001", 25000, "Suisse", "41mm", "Or rose", "Noir", "50m", "Montre à remontage manuel", "Heures et Minutes, Secondes, Date, Indicateur de réserve de marche", "Alligator", "Noir", DEFAULT, NULL, 8, 
...
-- 58
    ("H. Moser & Cie.", "Endeavour Perpetual Calendar", "1341-0500", 19450, "Switzerland", "41mm", "Titane", "Noir", "30m", "Montre à remontage manuel", "Date, Heures et Minutes, Mois, Calendrier perpétuel, Indicateur de réserve de marche, Secondes", "Alligator", "Noir", DEFAULT, NULL, 1, 
...
-- 59
    ("H. Moser & Cie.", "Pioneer Tourbillon", "3804-1205", 37250, "Suisse", "42mm", "Acier inoxydable", "Bleu", "120m", "Automatique", "Heures et minutes, Secondes, Tourbillon", "Acier inoxydable", "Argent", DEFAULT, NULL, 2,
...
-- 60
    ("H. Moser & Cie.", "Pioneer Perpetual Calendar", "3800-0900", 24150, "Suisse", "42mm", "Or rose", "Gris", "120m", "Montre à remontage manuel", "Heures et Minutes, Secondes, Date, Indicateur de réserve de marche", "Caoutchouc", "Noir", DEFAULT, NULL, 1,
...
-- 61
    ("H. Moser & Cie.", "Pioneer S RB Limited Edition", "3200-0500", 15750, "Suisse", "40mm", "Titane", "Bleu", "120m", "Automatique", "Heures et minutes, Secondes", "Titane", "Gris", DEFAULT, NULL, 3,
...
-- 62
    ("H. Moser & Cie.", "Streamliner Tourbillon", "6804-1201", 69650, "Suisse", "40mm", "Acier inoxydable", "Gris", "120m", "Automatique", "Heures et minutes, Tourbillon", "Acier inoxydable", "Argent", DEFAULT, NULL, 2,
...
-- 63
    ("H. Moser & Cie.", "Streamliner Tourbillon", "6804-0401", 102150, "Suisse", "40mm", "Or Rose", "Noir", "120m", "Automatique", "Heures et minutes, Secondes, Tourbillon", "Or Rose", "Or Rose", DEFAULT, NULL, 3,
...
-- 64
    ("Omega", "Constellation Globemaster", "130.33.39.21.03.001", 6050, "Suisse", "39mm", "Acier inoxydable", "Bleu", "100m", "Automatique", "Date, Heures et minutes, Secondes", "Alligator", "Noir", DEFAULT, NULL, 2,
...
-- 65
    ("Omega", "Constellation", "123.55.31.20.51.001", 8700, "Suisse", "31mm", "Or blanc", "Noir", "100m", "Automatique", "Date, Heures et Minutes, Secondes", "Or blanc", "Argent", DEFAULT, NULL, 3,
...
-- 66
    ("Omega", "Constellation", "123.53.35.60.63.001", 5050, "Suisse", "35mm", "Or rose", "Marron", "100m", "Quartz", "Heures et Minutes, Secondes, Date", "Alligator", "Marron", DEFAULT, NULL, 5,
...
-- 67
    ("Omega", "De Ville Prestige", "424.10.37.20.03.001", 2750, "Suisse", "37mm", "Acier inoxydable", "Bleu", "30m", "Automatique", "Date, Heures et minutes, Secondes", "Acier inoxydable", "Argent", DEFAULT, NULL, 2,
...
--68
    ("Omega", "De Ville Tresor", "432.58.40.21.05.003", 8800, "Suisse", "40mm", "Or rose", "Blanc", "30m", "Montre à remontage manuel", "Date, Heures et Minutes, Secondes", "Alligator", "Marron", DEFAULT, NULL, 5,
...
-- 69
    ("Omega", "Seamster 300 'Spectre' Limited Edition", "233.32.41.21.01.001", 11250, "Suisse", "41mm", "Acier inoxydable", "Noir", "300m", "Automatique", "Antimagnétique, Heures et minutes, Secondes", "Acier inoxydable", "Argent", DEFAULT, NULL, 4,
...
-- 70
    ("Omega", "Seamaster Planet Ocean 600M 'Deep Black'", "215.63.46.22.01.001", 10200, "Suisse", "45mm", "Céramique", "Noir", "600m", "Automatique", "Antimagnétique, Date, Gmt/Heure mondiale, Valve de libération d'hélium, Heures et minutes, Secondes", "Alligator", "Noir", DEFAULT, NULL, 2,
...
-- 71
    ("Omega", "Seamaster Aqua Terra 150M Chronometer", "220.92.43.22.99.001", 10700, "Suisse", "43mm", "Titane", "Gris", "150m", "Automatique", "Antimagnétique, Date, Gmt/Heure mondiale, Heures et minutes, Secondes", "Caoutchouc", "Noir", DEFAULT, NULL, 1,
...
-- 72
    ("Omega", "Speedmaster Professional Moonwatch Apollo Limited Edition", "311.30.42.30.99.001", 17450, "Suisse", "42mm", "Acier inoxydable", "Noir", "50m", "Montre à remontage manuel", "Chronographe, Heures et minutes, Secondes, Tachymètre", "Acier inoxydable", "Argent", DEFAULT, NULL, 3,
...
-- 73
    ("Omega", "Speedmaster Moonwatch Chronograph", "311.63.44.51.99.001", 13100, "Suisse", "44mm", "Céramique", "Gris, Météorite", "50m", "Automatique", "Chronographe, Date, Heures et minutes, Secondes, Tachymètre", "Alligator", "Gris", DEFAULT, NULL, 5,
...
-- 74
    ("Omega", "Speedmaster Anniversary Series Chronograph", "310.60.42.50.99.001", 46050, "Suisse", "42mm", "Or jaune", "Champagne", "50m", "Mouvement à remontage manuel", "Antimagnétique, Chronographe, Heures et minutes, Secondes, Tachymètre", "Or jaune", "Or jaune", DEFAULT, NULL, 2,
...
-- 75
    ("Patek Philippe", "Aquanaut", "5060A-001", 48700, "Suisse", "35mm", "Acier inoxydable", "Noir", "120m", "Automatique", "Date, Heures et minutes, Secondes", "Caoutchouc", "Marron", DEFAULT, NULL, 2,
...
-- 76
    ("Patek Philippe", "Aquanaut", "5168G-001", 74550, "Suisse", "42mm", "Or blanc", "Bleu", "120m", "Automatique", "Date, Heures et minutes, Secondes", "Caoutchouc", "Bleu", DEFAULT, NULL, 1,
...
-- 77
    ("Patek Philippe", "Aquanaut", "5066/1J-001", 65500, "Suisse", "36mm", "Or jaune", "Noir", "120m", "Automatique", "Date, Heures et minutes, Secondes", "Or jaune", "Or jaune", DEFAULT, NULL, 3,
...
-- 78
    ("Patek Philippe", "Calatrava", "5196G-001", 16700, "Suisse", "37mm", "Or blanc", "Argent", "30m", "Montre à remontage manuel", "Heures et minutes, Secondes", "Alligator", "Noir", DEFAULT, NULL, 5,
...
-- 79
    ("Patek Philippe", "Calatrava", "3802/205", 14400, "Suisse", "33mm", "Or jaune", "Blanc", "30m", "Automatique", "Heures et Minutes, Secondes, Date", "Or jaune", "Or jaune", DEFAULT, NULL, 6, 
...
-- 80
    ("Patek Philippe", "Calatrava Pilot Travel Time", "5524R-001", 37250, "Suisse", "42mm", "Or rose", "Marron", "60m", "Automatique", "Gmt/Heure mondiale, Heures et minutes, Secondes", "Cuir", "Marron", DEFAULT, NULL, 3, 
...
-- 81
    ("Patek Philippe", "Complications World Time", "5231G-001", 107250, "Suisse", "38mm", "Or blanc", "Multi-color, Argent", "30m", "Automatique", "GMT/Heure mondiale, Heures et Minutes", "Alligator", "Bleu", DEFAULT, NULL, 2, 
...
-- 82
    ("Patek Philippe", "175th Anniversary Chronograph", "5975J-001", 54050, "Suisse", "40mm", "Or jaune", "Argent", "50m", "Automatique", "Chronographe, Heures et minutes, Secondes", "Alligator", "Marron", DEFAULT, NULL, 2, 
...
-- 83
    ("Patek Philippe", "Complications Annual Calendar", "5396R-015", 60900, "Suisse", "38mm", "Or rose", "Bleu", "30m", "Automatique", "Indicateur 24 heures, Calendrier annuel, Date, Jour, Mois, Phase de lune, Heures et minutes, Secondes", "Alligator", "Bleu", DEFAULT, NULL, 3, 
...
-- 84
    ("Patek Philippe", "Gondolo Serata", "4972G-001", 17450, "Suisse", "27mm", "Or blanc", "Perle, Blanc", "30m", "Quartz", "Heures et minutes", "Satin", "Bleu", DEFAULT, NULL, 2, 
...
-- 85
    ("Patek Philippe", "Gondolo", "5100J-001", 27200, "Suisse", "34x46mm", "Or jaune", "Argent", "30m", "Montre à remontage manuel", "Heures et minutes, Indicateur de réserve de marche, Secondes", "Alligator", "Noir", DEFAULT, NULL, 3, 
...
-- 86
    ("Patek Philippe", "Gondolo", "5098P-001", 21600, "Suisse", "32x42mm", "Platine", "Argent", "30m", "Montre à remontage manuel", "Heures et minutes", "Alligator", "Noir", DEFAULT, NULL, 2, 
...
-- 87
    ("Patek Philippe", "Grand Complications Perpetual Calendar Chronograph", "5270G-001", 115950, "Suisse", "41mm", "Or blanc", "Argent", "30m", "Montre à remontage manuel", "Chronographe , Date , Jour , Indicateur jour/nuit , Heures et minutes , Phase de lune , Calendrier perpétuel , Secondes", "Alligator", "Noir",DEFAULT, NULL, 1,
...
-- 88
    ("Patek Philippe", "Grand Complications Minute Repeater Chronograph", "5208R-001", 1118600, "Suisse", "42mm", "Or rose", "Noir", "30m", "Automatique", "Chronographe , Date , Jour , Indicateur jour/nuit , Heures et minutes , Répétition minutes , Mois , Phase de lune , Calendrier perpétuel , Secondes", "Alligator", "Noir",DEFAULT, NULL, 1,
...
-- 89
    ("Patek Philippe", "Grand Complications Sky Moon Tourbillon", "5002P-001", 2034850, "Suisse", "42mm", "Platine", "Argent", "30m", "Montre à remontage manuel", "Heures et Minutes , Secondes , Date , Jour , GMT/Heure Mondiale , Mois , Phase de Lune , Tourbillon", "Alligator", "Noir",DEFAULT, NULL, 1,
...
-- 90
    ("Patek Philippe", "Nautilus Moonphase", "5712/1A-001", 100900, "Suisse", "40mm", "Acier inoxydable", "Noir, Bleu", "60m", "Automatique", "Date , Heures et minutes , Phase de lune , Indicateur de réserve de marche , Secondes", "Acier inoxydable", "Argent", DEFAULT, NULL, 3,
...
-- 91
    ("Patek Philippe", "Nautilus", "3800/5", 79550, "Suisse", "37mm", "Or jaune", "Or jaune", "120m", "Automatique", "Heures et Minutes , Secondes", "Or jaune", "Or jaune", DEFAULT, NULL, 3,
...
-- 92
    ("Patek Philippe", "Nautilus Chronograph", "5980R-001", 113000, "Suisse", "40mm", "Or rose", "Marron", "120m", "Automatique", "Chronographe , Date , Heures et minutes , Secondes", "Cuir", "Marron",DEFAULT, NULL, 3,
...
-- 93
    ("Vacheron Constantin", "Fiftysix", "4600E/000A-B487", 13000, "Suisse", "40mm", "Acier inoxydable", "Bleu", "30m", "Automatique", "Date , Heures et minutes , Secondes", "Alligator", "Bleu",DEFAULT, NULL, 4,
...
-- 94
    ("Vacheron Constantin", "Fiftysix Complete Calendar", "4000E/000R-B438", 33500, "Suisse", "40mm", "Or rose", "Argent", "30m", "Automatique", "Date , Jour , Heures et minutes , Mois , Phase de lune , Secondes", "Alligator", "Marron",DEFAULT, NULL, 2,
...
-- 95 
    ("Vacheron Constantin", "Historiques Triple Calendrier 1942", "3110V/000A-B425", 16800, "Suisse", "40mm", "Acier inoxydable", "Ivoire", "30m", "Montre à remontage manuel", "Calendrier , Date , Jour , Heures et minutes , Mois , Secondes", "Alligator", "Noir",DEFAULT, NULL, 1,
...
-- 96
    ("Vacheron Constantin", "Historiques Cornes de Vache 1955", "5000H/000R-B059", 46800, "Suisse", "38mm", "Or rose", "Blanc", "30m", "Montre à remontage manuel", "Chronographe , Heures et minutes , Secondes", "Cuir", "Marron",DEFAULT, NULL, 3,
...
-- 97 
    ("Vacheron Constantin", "Historiques Cornes De Vache 1955", "5000H/000P-B058", 51500, "Suisse", "38mm", "Platine", "Argent", "150m", "Montre à remontage manuel", "Chronographe , Heures et Minutes , Secondes , Tachymètre", "Alligator", "Bleu",DEFAULT, NULL, 2,
...
-- 98
    ("Vacheron Constantin", "Malte", "42008/000G-8979", 12800, "Suisse", "35x392mm", "Or blanc", "Argent", "50m", "Automatique", "Date , Jour , Heures et Minutes , Secondes", "Alligator", "Noir",DEFAULT, NULL, 3,
...
-- 99
    ("Vacheron Constantin", "Malte", "82230/000R-9963", 18500, "Suisse", "36mm", "Or rose", "Argent", "50m", "Montre à remontage manuel", "Heure seulement , Heures et minutes , Secondes", "Alligator", "Noir",DEFAULT, NULL, 4,
...
-- 100
    ("Vacheron Constantin", "Malte Tonneau Tourbillon Openworked", "30067/000P-8953", 83900, "Suisse", "36mm", "Platine", "Squelette", "30m", "Montre à remontage manuel", "Date , Heures et minutes , Secondes , Tourbillon", "Alligator", "Noir",DEFAULT, NULL, 2,
...
-- 101
    ("Vacheron Constantin", "Metiers dArt Les Masques China Mask Limited Edition", "86070/000J-9400", 67250, "Suisse", "40mm", "Or jaune", "Transparent", "30m", "Mechanique (Automatique)", "Heures et Minutes , Secondes , Jour et Date , Minutes sautées", "Alligator", "Marron", DEFAULT, NULL, 1,
...
-- 102
    ("Vacheron Constantin", "Metiers D'Art 'Nightingale'", "33222/000R-9517", 30850, "Suisse", "40mm", "Or rose", "Noir, Squelette", "30m", "Montre à remontage manuel", "Heures et Minutes , Secondes", "Alligator", "Noir", DEFAULT, NULL, 1,
...
-- 103
    ("Vacheron Constantin", "Metiers dArt Les Masques Mexico Mask Limited Edition", "86070/000P-9401", 67050, "Suisse", "40mm", "Platine", "Transparent", "30m", "Mechanique (Automatique)", "Heures et Minutes , Secondes , Jour et Date , Minutes sautées", "Alligator", "Marron", DEFAULT, NULL, 1,
...
-- 104
    ("Vacheron Constantin", "Overseas", "4500V/110A-B483", 23850, "Suisse", "41mm", "Acier inoxydable", "Noir", "150m", "Automatique", "Date , Heures et Minutes , Secondes", "Acier inoxydable", "Argent", DEFAULT, NULL, 5,
...
-- 105
    ("Vacheron Constantin", "Overseas Chronograph", "49140/423J-8791", 46350, "Suisse", "40mm", "Or jaune", "Argent", "150m", "Automatique", "Heures et Minutes , Secondes , Chronographe , Date", "Or jaune", "Or jaune",DEFAULT, NULL, 2,
...
-- 106
    ("Vacheron Constantin", "Overseas", "4500V/110R-B705", 64400, "Suisse", "41mm", "Or rose", "Bleu", "150m", "Automatique", "Date , Heures et Minutes , Secondes", "Or rose", "Or rose",DEFAULT, NULL, 2,
...
-- 107
    ("Vacheron Constantin", "Patrimony Traditionnelle Chronograph", "47192/000G-9504", 32200, "Suisse", "42mm", "Or blanc", "Argent", "30m", "Montre à remontage manuel", "Chronographe , Heures et Minutes , Secondes", "Alligator", "Noir",DEFAULT, NULL, 1,
...
-- 108
    ("Vacheron Constantin", "Patrimony", "81180/000R-9159", 13850, "Suisse", "40mm", "Or rose", "Argent", "30m", "Montre à remontage manuel", "heures et minutes", "Alligator", "Noir", DEFAULT, NULL, 2,
...
-- 109
    ("Vacheron Constantin", "Patrimony Grand Taille", "81180/000P-9539", 22200, "Suisse", "40mm", "Platine", "Gris", "50m", "Montre à remontage manuel", "heures et minutes", "Alligator", "Noir", DEFAULT, NULL, 3,
...
-- 110
    ("Vacheron Constantin", "Traditionnelle Complete Calendar Openface", "4020T/000G-B655", 42200, "Suisse", "41mm", "Or blanc", "Gris, Squelette", "30m", "Automatique", "Date , Jour , Heures et minutes , Mois , Phase de lune", "Alligator", "Gris",DEFAULT, NULL, 1,
...
-- 111
    ("Vacheron Constantin", "Traditionnelle Complete Calendar Openface", "4020T/000R-B654", 44400, "Suisse", "41mm", "Or rose", "Gris, Squelette", "30m", "Automatique", "Date , Jour , Heures et minutes , Mois , Phase de lune", "Alligator", "Marron",DEFAULT, NULL, 1,
